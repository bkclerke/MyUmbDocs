...
Before using the Form Handler macro, you will need to make sure that the content editor can setup the [form settings](/Form-Handler/How-It-Works.html#form-settings-explained) on a node within Umbraco.
